  ...
  return (
    <section id='hero' className='w-[90%] m-auto flex lg:flex-row flex-col justify-between items-center gap-28 py-20 sm:px-20'>
      <div className='flex flex-col justify-center items-start gap-8'>
        <h1 data-aos="zoom-in" datatype-aos-delay="" className='text-black font-semibold lg:text-[90px] text-[65px] lg:leading-[80px] font-ubuntu'>
          The Web Nursery
        </h1>
        <h2 data-aos="zoom-in" datatype-aos-delay="" className='text-black font-semibold lg:text-[50px] text-[65px] lg:leading-[50px] font-ubuntu'>
